      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-[#E1193E] text-white p-6 sm:p-10 lg:p-12 shadow-xl shadow-red-500/10">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8">
          ...
          <div className="flex items-center gap-5 sm:gap-6 text-center md:text-left">
            <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white flex items-center justify-center flex-shrink-0 shadow-md">
          ...
          <button
            ...
            className="flex-shrink-0 inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 rounded-full bg-white text-[#E1193E] font-semibold text-sm sm:text-base hover:bg-gray-50 transition-all duration-200 shadow-sm hover:shadow hover:scale-[1.02] active:scale-[0.98]"
          >
