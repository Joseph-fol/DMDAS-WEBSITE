...
// Top-Right Curved Hero Image with 3 African University Students collaborating on a laptop in library
export function HeroCampusVisual() {
  return (
    <div className="relative w-full max-w-lg lg:max-w-xl mx-auto flex items-center justify-center">
      ...
      <div className="relative z-10 w-full overflow-hidden rounded-[2.5rem] lg:rounded-[3.5rem] border-4 border-white shadow-2xl bg-gradient-to-br from-red-50 to-gray-100">
        <div className="relative aspect-[4/3] w-full">
          {/* High-quality Unsplash image representing 3 diverse students collaborating with laptop in library */}
          ...
          <div className="bg-white/95 backdrop-blur-sm p-2.5 sm:p-3 rounded-2xl shadow-sm border border-pink-100 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 leading-tight">
                Institutions upload & distribute manuals digitally.
              </p>
            </div>
          </div>
